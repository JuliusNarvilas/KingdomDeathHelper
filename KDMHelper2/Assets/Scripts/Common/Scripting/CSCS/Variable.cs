...
namespace SplitAndMerge
{
    public class Variable
    {
        ...
        public int GetArrayIndex(Variable indexVar)
        {
            ...
            int result = -1;
            if (!String.IsNullOrEmpty(indexVar.String) &&
        ...
        public Variable GetProperty(string propName, ParsingScript script = null)
        {
            ...
            if (Object is ScriptObject)
            {
                ...
                if (!string.IsNullOrEmpty(match))
                {
                    ...
                    var taskResult = obj.GetProperty(match, args, script);
                    result   = taskResult != null ? taskResult : null;
                    if (result != null)
                    {
                        return result;
                    }
        ...
        Variable GetCoreProperty(string propName, ParsingScript script = null)
        {
            ...
            {
                bool isEmpty = string.IsNullOrEmpty(AsString());
                                                   ...
                                                   string baseName = "", Variable root = null)
        {
            ...
            if (string.IsNullOrEmpty(match))
            {
                ...
                if (root != null)
                {
                    string objName = !string.IsNullOrEmpty(baseName) ? baseName + "." : "";
        ...
        private string m_currentAssign = string.Empty;
        public string CurrentAssign {
            get
            {
                return m_currentAssign;
            }
            set
            {
                m_currentAssign = value;
            }
        }
