...
{
    public enum PropertyDataDisplayMode
    {
    ...
    public class PropertyDataDisplayConfig : ScriptableObject
    {

        public virtual GameObject BuildDisplay(object property, PropertyDataDisplayMode mode)
        {
            return null;
        }
